...
start(Request, Timeout) ->
    ...
    {ok, _} = quantumdb_coverage_fsm_sup:start_fsm([ReqId, self(), Request, Timeout]),
    receive
        {ReqId, Val} -> Val
    end.
...
init(_, [ReqId, From, Request, Timeout]) ->
    ...
    {Request, allup, 1, 1, quantumdb, quantumdb_vnode_master, Timeout, State}.
